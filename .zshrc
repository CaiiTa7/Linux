...
start_vpn() {
    dev="vpn_vpn"
    sudo /opt/softether/vpnclient/vpnclient start > /dev/null 2>&1
...
alias clean_all="sudo pacman -Scc"
alias restart="sudo shutdown -r now"
alias resart_service="sudo systemctl restart"
alias stop_service="sudo systemctl stop"
alias start_service="sudo systemctl start"
alias enable_service="sudo systemctl enable"
alias status_service="sudo systemctl status"
alias journal_service="sudo journalctl -u"
